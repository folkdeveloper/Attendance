...
public class ResDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterD = new DetailsAdapter(ResDetails.this,R.layout.details_layout,details);
    }
                    ...
                    .addSnapshotListener(this, new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                            ...
                            for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                                ...
                                if (note.getRes_interest() == null)
                                    continue;

                                if (note.getRes_interest().equals("Yes")) {
                            ...
                            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent intent = new Intent(ResDetails.this, DetailsFinal.class);
...
//                    .whereEqualTo("zzdate", date)
    ...
    public void select1(View v) {
        Intent intent = new Intent(ResDetails.this, DateSelector.class);
        startActivity(intent);
    }
